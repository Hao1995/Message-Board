...
<div class="container h-container">
    ...
    <div class="row h-row-2">
        <form class="form-horizontal h-form" method="post" action="/file" accept-charset="UTF-8" enctype="multipart/form-data">  
            <input type="file" class="form-control h-input" id="user_icon_file" name="user_icon_file" placeholder="上傳圖片" value="">
